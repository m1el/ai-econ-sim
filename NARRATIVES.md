...
Deeper dives: [the objections people raise](OBJECTIONS.md) to every comfortable mechanism here, [how the aging population interacts with each future](AGING.md), [how violence from the populace is priced in](VIOLENCE.md), [what jobs look like in each world](JOBS.md), and [how to specialize when you can't choose the future](SPECIALIZATION.md).
